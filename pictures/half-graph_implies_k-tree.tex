\begin{figure}
	...
	\draw[solid edge, thin] (a_2) -- (b_1);
	\draw[solid edge, thin] (a_3) -- (b_1);
	\draw[solid edge, thin] (a_4) -- (b_1);
	\draw[solid edge, thin] (a_5) -- (b_1);
	\draw[solid edge, thin] (a_6) -- (b_1);
	\draw[solid edge, thin] (a_7) -- (b_1);
	\draw[solid edge, thin] (a_8) -- (b_1);
	\draw[solid edge, thin] (a_9) -- (b_1);
	\draw[solid edge, thin] (a_10) -- (b_1);
	\draw[solid edge, thin] (a_2) -- (b_2);
	\draw[solid edge, thin] (a_3) -- (b_2);
	\draw[solid edge, thin] (a_4) -- (b_2);
	\draw[solid edge, thin] (a_5) -- (b_2);
	\draw[solid edge, thin] (a_6) -- (b_2);
	\draw[solid edge, thin] (a_7) -- (b_2);
	\draw[solid edge, thin] (a_8) -- (b_2);
	\draw[solid edge, thin] (a_9) -- (b_2);
	\draw[solid edge, thin] (a_10) -- (b_2);
	\draw[solid edge, thin] (a_4) -- (b_3);
	\draw[solid edge, thin] (a_5) -- (b_3);
	\draw[solid edge, thin] (a_6) -- (b_3);
	\draw[solid edge, thin] (a_7) -- (b_3);
	\draw[solid edge, thin] (a_8) -- (b_3);
	\draw[solid edge, thin] (a_9) -- (b_3);
	\draw[solid edge, thin] (a_10) -- (b_3);
	\draw[solid edge, thin] (a_6) -- (b_4);
	\draw[solid edge, thin] (a_7) -- (b_4);
	\draw[solid edge, thin] (a_8) -- (b_4);
	\draw[solid edge, thin] (a_9) -- (b_4);
	\draw[solid edge, thin] (a_10) -- (b_4);
	\draw[solid edge, thin] (a_6) -- (b_5);
	\draw[solid edge, thin] (a_7) -- (b_5);
	\draw[solid edge, thin] (a_8) -- (b_5);
	\draw[solid edge, thin] (a_9) -- (b_5);
	\draw[solid edge, thin] (a_10) -- (b_5);
	\draw[solid edge, thin] (a_10) -- (b_6);
	\draw[solid edge, thin] (a_8) -- (b_7);
	\draw[solid edge, thin] (a_9) -- (b_7);
	\draw[solid edge, thin] (a_10) -- (b_7);
	\draw[solid edge, thin] (a_10) -- (b_8);
	\draw[solid edge, thin] (a_10) -- (b_9);
	\draw[solid edge, thin] (a_10) -- (b_10);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_2) -- (b_3);
	\draw[solid edge, thick, orange!70!red] (a_3) -- (b_3);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_2) -- (b_4);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_3) -- (b_4);
	\draw[solid edge, thick, orange!70!red] (a_4) -- (b_4);
	\draw[solid edge, thick, orange!70!red] (a_5) -- (b_4);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_4) -- (b_5);
	\draw[solid edge, thick, orange!70!red] (a_5) -- (b_5);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_2) -- (b_6);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_3) -- (b_6);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_4) -- (b_6);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_5) -- (b_6);
	\draw[solid edge, thick, orange!70!red] (a_6) -- (b_6);
	\draw[solid edge, thick, orange!70!red] (a_7) -- (b_6);
	\draw[solid edge, thick, orange!70!red] (a_8) -- (b_6);
	\draw[solid edge, thick, orange!70!red] (a_9) -- (b_6);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_6) -- (b_7);
	\draw[solid edge, thick, orange!70!red] (a_7) -- (b_7);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_6) -- (b_8);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_7) -- (b_8);
	\draw[solid edge, thick, orange!70!red] (a_8) -- (b_8);
	\draw[solid edge, thick, orange!70!red] (a_9) -- (b_8);
	\draw[dashed edge, dash pattern=on 3pt off 3pt, thick, orange!70!red] (a_8) -- (b_9);
	\draw[solid edge, thick, orange!70!red] (a_9) -- (b_9);
...
\begin{scope}[xshift=12 cm]
   ...
   \end{scope}
    ...
    \end{tikzpicture}
    \caption{\emph{On the left}, example of a $3$-tree in a half-graph with 2 × 10 vertices. 
Orange lines and nodes highlight the $3$-tree structure, with dashed orange lines remarking the relevant non-edges. 
