...
On the other hand, raising the value of $\epsilon$ up to $\frac{2}{5}$ introduces a new 
$\frac{2}{5}$-good set $B$ witnessing that $A$ is not $\frac{2}{5}$-excellent, as half of the vertices of $A$ have one truth value, and half the other. 
