\section{Graphs and the SzRL} \label{sec:section_2}
    ...
    \subsection{Regular pairs and partitions} \label{subsec:subsection_2.2}
        ...
        \begin{remark}
            ...
            in the partition, and not necessarily by the remainder, in even partitions the behaviour of a
    ...
    \subsection{Szemerédi's Regularity Lemma} \label{subsec:subsection_2.3}
        ...
        \begin{theorem}[Szemer\'edi's Regularity Lemma, \cite{regular_partitions_of_graphs}] \label{thm:szemeredi_regularity_lemma}
            ...
            $\parcurly{A_1, \ldots, A_k}$ and remainder $B$ with $m \leq k \leq M$.
        \end{theorem}
        ...
        Let $\overline{A}$ be a partition with remainder set $B$, we define
        ...
        \begin{lemma} \label{lem:increase_in_energy_when_refining_an_irregular_partition}
            ...
            \begin{proof}
                ...
                \]
                of $G$ with remainder set still $B$.
                ...
                remaining vertices to the remainder set.
                We need to separate two cases, as we may not have enough vertices to make substantially sized parts.

                If $c < 4^k$, we just consider all the parts to be singletons, and keep the remainder set $B$ as it is.
        ...
        enough remainder set, and then keep refining it until we reach a regular partition.
        ...
        \begin{proof}[Proof of \Cref{thm:szemeredi_regularity_lemma}]
            ...
            This is possible by monotonicity of the regularity condition\footnote{
                ...
                then it is also $\epsilon'$-regular for any $\epsilon' \geq \epsilon$.
            ...
            At each refinement, the size of the remainder set increases by at most $\frac{n}{2^k}$, where $k$ is the
            ...
            are added to the remainder set.
            ...
            as the choice of $k$ and $n\geq M$ in~\eqref{eq:final_remainder_size_bound} ensures that the remainder is
        ...
        to~\cite{graph_removal_lemmas, graph_theory_and_additive_combinatorics_exploring_structure_and_randomness}\footnote{
            ...
            \cite{graph_removal_lemmas} proves the existence of a partition has regular self-pairs and no remainder, but
