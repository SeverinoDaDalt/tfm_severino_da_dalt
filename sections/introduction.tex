\section{Introduction} \label{sec:introduction}
    ...
    % Decimos: este graph es un bipartido poco random. Conectamos con VC-dimension diciendo que implica bounded VC y
    % de hecho evitar cualquier bipartido implica bounded VC (cita).
