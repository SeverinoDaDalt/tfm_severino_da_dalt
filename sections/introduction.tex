\section{Introduction} \label{sec:introduction}
    ...
    \subsection{Szemer\'edi's Regularity Lemma}
        ...
        Ramsey Theory~\cite{threshold_functions_for_ramsey_properties,
            three-color_ramsey_numbers_for_paths,
            ramsey_turan_theory,},
        in combinatorics, and the regularity method has been generalized to hypergraphs~\cite{
    ...
    \jojo
    % explain that 4.1 is to deal with irregular pairs
