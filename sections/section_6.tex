\section{Property testing} \label{sec:section_6}
    ...
    \subsection{Unavoidable is abundant} \label{subsec:subsection_6.1}
        ...
        if and only if $d(A_i, A_j) > T$, for some threshold value $T \in \parround{0,1}$.
        ...
        reduced graph \todo{Define reduced subgraph as a remark of the stable regularity lemma.} from a regular
        partition contains an induced structure resembling $H$, i.e. where pairs of parts are
