\section{Section 6} \label{sec:section_6}
    \definition \label{def:unavoidable}
    ...
    \definition \label{def:abundant}
        A graph $H$ is \emph{$\eta$-abundant} in a graph $G$ if $G$ contains at least $\eta |G|^{|H|}$
        induced copies of $H$.

    \lemma[Lemma 3.1 of "Efficient Testing of Large graphs", \it{Alon et al.}] \label{lem:regularity_is_transitive}
    ...
    \lemma[Lemma 3.2 of "Efficient Testing of Large graphs", \it{Alon et al.}] \label{lem:H_like_partition_implies_H_abundance}
    ...
    \theorem \label{lem:property_testing_with_stable_partitions}
