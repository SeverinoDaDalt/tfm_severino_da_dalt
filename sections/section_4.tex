...
%    So, $n^{\epsilon^{k_{**}}} > k_{**}$.
    ...
    \remark\label{sufficient_requirement_for_average_condition}
    ...
    \todo{since we changed $\ell \in [k_**]$ to $\ell < k_**$, you should adapt consequently all that follows this point...}
    ...
    \lemma[Claim 4.14]\label{existance_of_equitative_partition_with_bound_exceptional_pairs}
        ...
        \begin{proof}
            ...
            \[
                ...
                \end{split}
            \]
            \todo{Third inequality needs some explanation}
    ...
    \theorem[Theorem 4.16]
        ...
        \end{proof}
    \todo{Make a complementary of this theorem with another value of c, which removes the need of $(1-2\epsilon)$ in (3).}
