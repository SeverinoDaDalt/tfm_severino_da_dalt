\section{Unbounded Stable Regularity Lemmas} \label{sec:section_4}
    ...
    \subsection{Indivisibility and Average Condition} \label{subsec:subsection_4.1}
        ...
        \begin{corollary}[Corollary 4.9] \label{cor:exceptions_bound_of_c_indivisible_sets}
    ...
    \subsection{$\epsilon$-indivisible Equitable Partition} \label{subsec:subsection_4.2}
    ...
    \subsection{$f_c$-indivisible Equitable Partition} \label{subsec:subsection_4.3}
        ...
        \begin{remark}
            ...
            \Cref{eq:n_large_enough_valid_values.1}.
        ...
        We now use the previous result to build an equitable partition.
        Similarly to \Cref{lem:existance_of_ordered_f_indivisible_partitions}, we will iteratively extract an $f_c$-indivisible
        set from the reminder using \Cref{lem:many_values_to_equitative_partition_with_bound_exceptional_pairs}, until
