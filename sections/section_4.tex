\section{Section 4} \label{sec:section_4}
    ...
    This section works around the idea of \emph{$\epsilon$-indivisible} sets, a strong condition on the regularity of a subset
    ...
    strongly non-homogeneous partition.
...
\begin{lemma}[Claim 4.6)] \label{lem:average_condition_statement}
    ...
    \begin{lemma}[Claim 4.3] \label{lem:existance_of_indivisible_sets}
        ...
        \begin{proof}
            ...
            with the property:
            \[
                \forall \rho \in \parcurly{0,1}^{<k_{**}} \forall \eta \in \parcurly{0,1}^{k_{**}} \text{ such that } \rho^\frown \partriangle{i} \trianglelefteq
    ...
    \begin{lemma}[Claim 4.10] \label{lem:existance_of_ordered_f_indivisible_partitions_with_exceptions_bound}
        ...
        \begin{enumerate}
            ...
            \item \label{itm:existance_of_ordered_f_indivisible_partitions_with_exceptions_bound.3} $A_i \cap A_j = \emptyset$ $\forall i \neq j$.
    ...
    \begin{lemma}[Claim 4.21] \label{lem:many_values_to_equitative_partition_with_bound_exceptional_pairs}
        ...
        \begin{proof}
            ...
            \begin{itemize}
                ...
                \item $Z$ is $c$-indivisible since $|B \cap Z| \leq c \forall B \in P$, satisfying \dref{itm:many_values_to_equitative_partition_with_bound_exceptional_pairs.b}.
            \end{itemize}
            This proves the statement.
        \end{proof}
    \end{lemma}

    \begin{lemma}[Remark 4.22] \label{rmk:k_asterisk_enough_for_k}
