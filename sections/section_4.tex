\section{Unbounded stable regularity lemmas} \label{sec:section_4}
    ...
    \subsection{Indivisibility and the average condition} \label{subsec:subsection_4.1}
        ...
        \begin{lemma}[Claim 4.6 in~\cite{regularity_lemmas_for_stable_graphs}] \label{lem:average_condition_statement}
    ...
    \subsection{$f_c$-indivisible even partition} \label{subsec:subsection_4.3}
        ...
        set from the remainder using \Cref{lem:many_values_to_equitative_partition_with_bound_exceptional_pairs}, while
