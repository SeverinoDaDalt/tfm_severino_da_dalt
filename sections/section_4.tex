    ...
    \subsection{$f_c$-indivisible even partition} \label{subsec:subsection_4.3}
        ...
        \begin{lemma}[Claim 4.21 in~\cite{regularity_lemmas_for_stable_graphs}] \label{lem:many_values_to_equitative_partition_with_bound_exceptional_pairs}
            ...
            \begin{proof}
                ...
                \begin{itemize}
                    \item $|Z| = \floor{m_\ell^{\xi\epsilon^{-\ell}}}
                        ...
                        \geq f_\xi (n) - k_{**}
                        = \lfloor n^\xi \rfloor - k_{**}$, where $f_\epsilon(x)$ is defined in \Cref{clm:floor_exponential_composition_bound}.
                        This satisfies \dref{itm:many_values_to_equitative_partition_with_bound_exceptional_pairs.a}.
        ...
        \begin{remark}
            ...
            \begin{itemize}
                ...
                \item The $- k_{**}$ factor in the size of the parts is not a crucial dependence of the size of the parts
                    on this parameter, but just a by-product of using \Cref{clm:floor_exponential_composition_bound}
                    to deal with floor functions.
                    Careful computations can probably reduce this factor to a constant independent of any parameter.
