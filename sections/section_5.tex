\section{Section 5} \label{sec:section_5}
    ...
    \begin{lemma}[Claim 5.4] \label{existance_of_excellent_subsets}
        ...
        \begin{proof}
            ...
            satisfying:
            \begin{enumerate}
                \item\label{itm:5.4.1} $A_{\partriangle{\cdot}} = A$.
                \item\label{itm:5.4.2} $B_\eta$ is a $\zeta$-good set witnessing that $A_\eta$ is not
                    $(\epsilon, \zeta)$-excellent, for $k < k_{**}$.
                \item\label{itm:5.4.3} $A_{\eta \frown \partriangle{i}} = \parcurly{a \in A_\eta \mid t(a, B_\eta) \equiv i}$
                    for all $i \in \parcurly{0,1}$ and $k < k_{**}$.
                \item\label{itm:5.4.4} $\parstraight{A_{\eta \frown \partriangle{i}}} \geq \epsilon |A_\eta|$
                    for all $i \in \parcurly{0,1}$ and $k < k_{**}$.
                \item\label{itm:5.4.5} $|A_\eta| \geq \epsilon^k |A|$, for $k \leq k_{**}$.
                \item\label{itm:5.4.6} $A_\eta = A_{\eta \frown \partriangle{0}} \sqcup A_{\eta \frown \partriangle{1}}$,
                    for $k < k_{**}$.
                \item\label{itm:5.4.7} $\overline{A_k} = \parcurly{A_\eta \mid \eta \in [2]^k}$ is a partition of $A$,
                    for $k \leq k_{**}$.
            \end{enumerate}
            ...
            (\ref{itm:5.4.4}) follows the definition of $A_{\eta \frown \partriangle{i}}$ in (\ref{itm:5.4.3}) and
    ...
    \begin{lemma}[Claim 5.4.1] \label{existance_of_excellent_subsets_fixed_size_choices}
        Let $G$ be a finite graph with the non-$k_{*}$-order property.
        ...
        \begin{proof}
            ...
            satisfying:
            \begin{enumerate}
                \item\label{itm:5.4.1.1} $A_{\partriangle{\cdot}} \subseteq A$, with $|A|_{\partriangle{\cdot}} = m_0$.
                ...
                \item\label{itm:5.4.1.3} $A_{\eta \frown \partriangle{i}} = \parcurly{a \in A_\eta \mid t(a, B_\eta) \equiv i}$
                    for all $i \in \parcurly{0,1}$ and $k < k_{**}$.
                \item\label{itm:5.4.1.4} $|A_{\eta}| = m_k$, for all $k \leq k_{**}$.
                \item\label{itm:5.4.1.6} $A_{\eta \frown \partriangle{0}} \sqcup A_{\eta \frown \partriangle{1}} \subseteq A_\eta$,
                    for all $k < k_{**}$.
                \item\label{itm:5.4.1.7} $\overline{A_k} = \parcurly{A_\eta \mid \eta \in [2]^k}$ is a partition of
            ...
            $i \in \parcurly{0,1}$, satisfying (\ref{itm:5.4.1.4}).
    ...
    \begin{lemma}[Claim 5.13] \label{claim_5.13}
        Let $G$ be a finite graph with the non-$k_{*}$-order property.
        Then:
        \begin{enumerate}[label=(\alph*), ref=\alph*]
            \item \label{itm:5.13.1} For every $\epsilon \in \parround{0, \frac{1}{2}}$,
            ...
            \item \label{itm:5.13.2} For every $\zeta \in \parcurly{0, \frac{1}{2}}$ and $\zeta' < \zeta$, there is
            ...
            \item \label{itm:5.13.3} For all $\zeta \in \parround{0, \frac{1}{2}}$, $\zeta' < \zeta$, $r \geq 1$ and for all
    ...
    \begin{lemma}[Claim 5.13.2(3)] \label{existance_of_equitable_excellent_subpartition}
        Let $G$ be a finite graph with the non-$k_*$-property.
    ...
    \begin{lemma}[Claim 5.14.1] \label{existance_of_excellent_partition}
        Let $G$ be a finite graph with the non-$k_{*}$-order property.
    ...
    \begin{lemma}[Claim 5.14.1a] \label{existance_of_excellent_partition_with_equal_size}
        Let $G$ be a finite graph with the non-$k_{*}$-order property.
    ...
    \begin{lemma}[Claim 5.14.2] \label{existance_of_excellent_partition_with_equal_size_and_no_remainder}
    ...
    \begin{lemma}[Corollary 5.15] \label{resume_of_all_conditions_for_excellent_partitions}
    ...
    \begin{theorem}[Theorem 5.18] \label{minimal_conditions_for_excellent_partitions}
    ...
    \begin{lemma}[Lemma 5.17] \label{excellence_implies_regularity}
        ...
        Then, we have:
        \begin{enumerate}
            \item \label{itm:5.17.1} $\frac{\parstraight{Z}}{{\parstraight{A} \parstraight{B}}} < \epsilon_1 + \epsilon_2$.
            \item \label{itm:5.17.2} $\frac{\parstraight{Z'}}{\parstraight{A} \parstraight{B}} <
        ...
        \begin{proof}
            ...
            \begin{itemize}
                \item \underline{if $t\parround{A,B} = 1$}, then $d\parround{A,B} > 1 - \parround{\epsilon_1 + \epsilon_2}$
                    and $d \parround{A',B'} > 1 - \frac{\epsilon_1 + \epsilon_2}{\epsilon_3}$, which follows (\ref{itm:5.17.1}) and
    ...
    \begin{theorem}[Theorem 5.19] \label{thm:existance_of_regular_partitions}
        ...
        \begin{proof}
            ...
            to $A$ with $\frac{\epsilon^2}{2}$, and then use Lemma~\ref{excellence_implies_regularity} to replace the
