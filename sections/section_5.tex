\section{Section 5} \label{sec:section_5}
    ...
    \begin{remark}
        ...
        On the other hand, $\epsilon$-excellence carries some kind of reciprocity with other good (and in particularly
        ...
        excellence of a set $A$ also ensures that the truth values with respect to all the vertices of another good set
        $B$ are mostly the same.
    ...
    \begin{remark}
        ...
        it being also $\epsilon'$-excellent (and neither the converse).
    ...
    The first step to construct a partition of such sets, is to prove their existence under the stability condition.
    ...
    \Cref{lem:existance_of_excellent_subsets_fixed_size_choices} is actually the one we will be using for further
    ...
    The following lemma is a small calculus result, which will be required in the subsequent proof.
    The statement comes from~\cite{no_me_acuerdo} and, for completeness, we provide herea short proof here.
    ...
    Now we proceed to refine the partition from \Cref{lem:existance_of_excellent_partition} into an equitable one using
    the previous results.
    Notice that in the conditions we require a decreasing sequence of integers which has no direct appearance in the
    consequences.
    This is because it is part of the construction, and requiring its existence (in the context of the rest of the other
    variables) avoids unnecessary relaxations of the bounds or approximation errors.
    ...
    it is avoidable at the cost of aanother slight increase of the excellence parameter.
    ...
    We now resume all the conditions necessaries for the previous result to hold in the context of the previous remark.
    ...
    To conclude, we finally prove the existence of the decreasing sequence of integers, under some minimal conditions
