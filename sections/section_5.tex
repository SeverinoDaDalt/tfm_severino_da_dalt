\section{Section 5} \label{sec:section_5}
    ...
    \begin{remark}
        The property of a set being $\epsilon$-good is equivalent to the set being $f$-indivisible with $f(n) = \epsilon n$,
        and $\epsilon$-indivisible is a much stronger condition then $\epsilon$-good.
    \end{remark}
