        ...
        \begin{lemma}[Claim 5.13 in~\cite{regularity_lemmas_for_stable_graphs}] \label{lem:even_partition_of_excellent_parts}
            ...
            \begin{enumerate}[label=(\alph*), ref=\alph*]
                \item The proof of this point uses the hypergeometric distribution.
                    ...
                    Let $b\in G$ such that $\overline{B}_{A,b}$ is bad.
                    The elements of $\overline{B}_{A,b}$ are our fail elements when drawing from $A$, and
                    $A'$ is our sample (where elements are uniformly draw at random without replacement).
                    ...
                    deviating from $\epsilon$ is at most the probability of deviating from the real mean.
                    Thus,
                    \[
                ...
                \item
                    ...
                    and, since  $A$ is $\epsilon$-good, each exceptional vertex of $B$ has at least $(1-\epsilon)|A|$ exceptional edges.
                    Thus,
                    \begin{align} \nonumber
