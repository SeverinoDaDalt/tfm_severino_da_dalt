\section{Stable Graphs} \label{sec:section_3}
    ...
    \todo{No me gusta nada esta ultima frase. Y ponerlo como un footnote cuando definimos k-order? Al final solo
        queremos mencionar que el nombre cuadra con esta manera de ordenar los vertices...}
