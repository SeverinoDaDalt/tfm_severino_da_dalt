\section{Stable graphs} \label{sec:section_3}
    ...
    \subsection{The $k$-order property} \label{subsec:subsection_3.1}
        ...
        \begin{remark}
            ...
            See \Cref{fig:other_k-order} for an example.
        \end{remark}
    ...
    \subsection{VC-dimension and the Sauer-Shelah Lemma} \label{subsec:subsection_3.2}
        ...
        We begin by proving a stronger version of this lemma from Pajor, for which Sauer-Shelah will be a straightforward
        consequence.
        ...
        the excluded structures in stable graphs) is not crucial to obtain this value of the bound, but later on\footnote{
            Specifically, the non-disjointness of the sequences becomes relevant in \Cref{lem:existance_of_indivisible_sets} of
        ...
        The following equivalent versions of \Cref{lem:k_order_property_bounds_BAbs} will be useful
        ...
        The proof is given in \Cref{sec:appendix_other_proofs}.
    ...
    \subsection{Tree bound} \label{subsec:subsection_3.3}
        ...
        A key point of the next sections will be to prove that some sort of \say{regular} subgraphs
