\abstracteng{
    ...
    Despite its wide-ranging applications in areas like number theory and property testing, the lemma suffers from
    two major limitations:
    the number of parts in the partition is bounded by a tower of exponentials,
    and the existence of irregular pairs is unavoidable in the general case.
