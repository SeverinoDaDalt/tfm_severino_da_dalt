...
\vfill\newpage \section{Main changes} \label{sec:main_changes}
    ...
    \begin{itemize}
        ...
        \item Throughout section 5 of~\cite{regularity_lemmas_for_stable_graphs}, it is implicitly
            ...
            See \Cref{rmk:excellence_is_not_monotonic} and \Cref{sec:excellence_is_not_monotonic}.
            Not assuming such property requires many changes of the proof of the Stable Regularity Lemma
            (\Cref{sec:section_5}) some of which we mention below.
        ...
        \item On the other hand, (2) of Claim 5.13,
            ...
            (see \Cref{lem:even_partition_of_excellent_parts}) is probably a consequence of the excellence-monotonicity assumption.
