    ...
    \begin{proof}[Proof of \Cref{clm:floor_exponential_composition_bound}]
        ...
        \[
            f_{\epsilon_1 \epsilon_2} = \floor{x^{\epsilon_1 \epsilon_2}}
                ...
                \stackrel{\eqref{eq:exp_bound}, \eqref{eq:floor_bound}}{\leq} \floor{\floor{x^{\epsilon_1}}^{\epsilon_2}} + 1
        \]
        If $k > 2$,
        \[
            f_{\epsilon_1 \epsilon_2 \dots \epsilon_k} (x)
                \stackrel{\text{I.H. for }k-1}{\leq} f_{\epsilon_1 \epsilon_2} \circ f_{\epsilon_3} \circ \dots \circ f_{\epsilon_{k}} + k - 2
                \stackrel{\text{I.H. for }2}{\leq} f_{\epsilon_1} \circ f_{\epsilon_2} \circ f_{\epsilon_3} \circ \dots \circ f_{\epsilon_{k}} + k - 1
        \]
